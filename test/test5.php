                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h1 class="head" style="text-align: center;"> Expressions and control statements in PHP  </h1><br> <br>
                                ...
                                <input type="hidden" name="que4" value=" 4) _________________ is a way to convert one data type variable into the different data type.  "> </input> 4) _________________ is a way to convert one data type variable into the different data type.  <br><br>
                                ...
                                <input type="radio" name="ans5" value=" c) Pretext Hypertext Processor  " /> c) Pretext Hypertext Processor  <br>
