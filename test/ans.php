...
if(isset($_POST['save_radioo']))
{
    ...
    $ans  = $_POST['ans1'];
    $rig  = $_POST['right1'];
    $que_query = "INSERT INTO demo (que,ans,rig) VALUES ('$que','$ans','$rig')";
    ...
    $ans2  = $_POST['ans2'];
    $rig2  = $_POST['right2'];
    $que_query2 = "INSERT INTO demo (que,ans,rig) VALUES ('$que2','$ans2','$rig2')";
    ...
    $ans3  = $_POST['ans3'];
    $rig3  = $_POST['right3'];
    $que_query3 = "INSERT INTO demo (que,ans,rig) VALUES ('$que3','$ans3','$rig3')";
    ...
    $ans4  = $_POST['ans4'];
    $rig4  = $_POST['right4'];
    $que_query4 = "INSERT INTO demo (que,ans,rig) VALUES ('$que4','$ans4','$rig4')";
    ...
    $ans5  = $_POST['ans5'];
    $rig5  = $_POST['right5'];
    $que_query5 = "INSERT INTO demo (que,ans,rig) VALUES ('$que5','$ans5','$rig5')";
    ...
    $ans6  = $_POST['ans6'];
    $rig6  = $_POST['right6'];
    $que_query6 = "INSERT INTO demo (que,ans,rig) VALUES ('$que6','$ans6','$rig6')";
    ...
    $ans7  = $_POST['ans7'];
    $rig7  = $_POST['right7'];
    $que_query7 = "INSERT INTO demo (que,ans,rig) VALUES ('$que7','$ans7','$rig7')";
    ...
    $ans8  = $_POST['ans8'];
    $rig8  = $_POST['right8'];
    $que_query8 = "INSERT INTO demo (que,ans,rig) VALUES ('$que8','$ans8','$rig8')";
    ...
    $ans9  = $_POST['ans9'];
    $rig9  = $_POST['right9'];
    $que_query9 = "INSERT INTO demo (que,ans,rig) VALUES ('$que9','$ans9','$rig9')";
    ...
    $ans10  = $_POST['ans10'];
    $rig10  = $_POST['right10'];
    $que_query10 = "INSERT INTO demo (que,ans,rig) VALUES ('$que10','$ans10','$rig10')";
